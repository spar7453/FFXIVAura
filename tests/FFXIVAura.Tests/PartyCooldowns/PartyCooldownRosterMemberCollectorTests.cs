...
internal static class PartyCooldownRosterMemberCollectorTests
{
    ...
    {
        var contentMember = PartyCooldownMemberSnapshotFactory.Create(10, 100, 1, "Alpha", 19);
        var entityMember = PartyCooldownMemberSnapshotFactory.Create(20, 0, 1, "Beta", 19);
        var namedMember = PartyCooldownMemberSnapshotFactory.Create(0, 0, 1, "Gamma", 19);
    ...
    private static void ReplacesEntitylessCrossRealmMembers()
    {
        ...
        var crossRealm = PartyCooldownMemberSnapshotFactory.Create(0, 100, 1, "Alpha", 19);
        var partyList = PartyCooldownMemberSnapshotFactory.Create(10, 100, 1, "Alpha", 19);
    ...
    {
        var collector = new PartyCooldownRosterMemberCollector(4);
        var first = PartyCooldownMemberSnapshotFactory.Create(10, 100, 1, "Alpha", 19);
        var duplicateEntity = PartyCooldownMemberSnapshotFactory.Create(10, 200, 1, "Beta", 19);
    ...
    private static void RollsBackRejectedEntityReservations()
    {
        var collector = new PartyCooldownRosterMemberCollector(4);
        var first = PartyCooldownMemberSnapshotFactory.Create(10, 100, 1, "Alpha", 19);
        var duplicateKey = PartyCooldownMemberSnapshotFactory.Create(20, 100, 1, "Alpha", 19);
        var next = PartyCooldownMemberSnapshotFactory.Create(20, 200, 1, "Beta", 19);
